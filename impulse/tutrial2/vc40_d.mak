...
!MESSAGE 
!MESSAGE NMAKE /f "Vc40_d.mak" CFG="vc40g - Win32 Debug"
!MESSAGE 
...
"$(OUTDIR)\Vc40_d.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
"$(INTDIR)\vrmfile.obj" : $(SOURCE) $(DEP_CPP_VRMFI) "$(INTDIR)"
