...
!MESSAGE 
!MESSAGE NMAKE /f "text.MAK" CFG="vc40g - Win32 Debug"
!MESSAGE 
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "BISCSV" /Fp"$(INTDIR)/text.pch" /YX /c 
CPP_OBJS=
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/text.pdb" /machine:I386 /nodefaultlib:"libc.lib"\
 /out:"$(OUTDIR)/text.exe" 
LINK32_OBJS= \
	"$(INTDIR)/text.obj"

"$(OUTDIR)\text.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/text.pdb" /debug /machine:I386 /nodefaultlib:"libc.lib"\
 /out:"$(OUTDIR)/text.exe" 
LINK32_OBJS= \
	"$(INTDIR)/text.obj"
