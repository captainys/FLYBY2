...
!MESSAGE 
!MESSAGE NMAKE /f "TEST03.MAK" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/TEST03.exe $(OUTDIR)/TEST03.bsc
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"TEST03.bsc" 

$(OUTDIR)/TEST03.bsc : $(OUTDIR)  $(BSC32_SBRS)
LINK32=link.exe
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/TEST03.OBJ
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /NOLOGO /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"TEST03.pdb"\
 /MACHINE:I386 /OUT:$(OUTDIR)/"TEST03.exe" 

$(OUTDIR)/TEST03.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib wing32.lib impls32g.lib hotas32.lib shawk32.lib aurora32.lib\
 /NOLOGO /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"TEST03.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"TEST03.exe" 
...
DEP_TEST0=\
	...
	c:\msvc20\include\aurora.h

$(INTDIR)/TEST03.OBJ :  $(SOURCE)  $(DEP_TEST0) $(INTDIR)
